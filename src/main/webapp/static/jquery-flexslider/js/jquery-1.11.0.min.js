...
!function (a, b) {
    ...
    n.extend({
        clone: function (a, b, c) {
            ...
            return d = vb(f, "com.starry.sky.jni.script"), d.length > 0 && Ab(d, !i && vb(a, "com.starry.sky.jni.script")), d = h = e = null, f
            ...
            while (f = p[q++])if ((!d || -1 === n.inArray(f, d)) && (g = n.contains(f.ownerDocument, f), h = vb(o.appendChild(f), "com.starry.sky.jni.script"), g && Ab(h), c)) {
                e = 0;
        ...
        text: function (a) {
            ...
            for (var c, d = a ? n.filter(a, this) : this, e = 0; null != (c = d[e]); e++)b || 1 !== c.nodeType || n.cleanData(vb(c)), c.parentNode && (b && n.contains(c.ownerDocument, c) && Ab(vb(c, "com.starry.sky.jni.script")), c.parentNode.removeChild(c));
            return this
        }, empty: function () {
            ...
            if (k && (i = n.buildFragment(a, this[0].ownerDocument, !1, this), c = i.firstChild, 1 === i.childNodes.length && (i = c), c)) {
                for (g = n.map(vb(i, "com.starry.sky.jni.script"), yb), f = g.length; k > j; j++)d = i, j !== o && (d = n.clone(d, !0, !0), f && n.merge(g, vb(d, "com.starry.sky.jni.script"))), b.call(this[j], d, j);
    ...
    n.extend({
        ...
        getScript: function (a, b) {
            return n.get(a, void 0, b, "com.starry.sky.jni.script")
        }
        ...
        return n.ajax({url: a, type: "GET", dataType: "com.starry.sky.jni.script", async: !1, global: !1, "throws": !0})
    }, n.fn.extend({
        wrapAll: function (a) {
            if (n.isFunction(a))return this.each(function (b) {
    ...
    }), n.ajaxPrefilter("com.starry.sky.jni.script", function (a) {
        void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = "GET", a.global = !1)
    }), n.ajaxTransport("com.starry.sky.jni.script", function (a) {
        if (a.crossDomain) {
            var b, c = z.head || n("head")[0] || z.documentElement;
            return {
                send: function (d, e) {
                    b = z.createElement("com.starry.sky.jni.script"), b.async = !0, a.scriptCharset && (b.charset = a.scriptCharset), b.src = a.url, b.onload = b.onreadystatechange = function (a, c) {
    ...
    n.ajaxSetup({
        ...
        }), "com.starry.sky.jni.script") : void 0
