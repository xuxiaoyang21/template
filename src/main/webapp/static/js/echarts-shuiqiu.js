...
/***/ function(module, exports) {
	 ...
	 */
	    ...
	    Eventful.prototype = {
	        ...
	        /**
	         * 带有context的事件分�?, 最后一个参数是事件回调的context
	         * @param {string} type 事件类型
	         */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Animatable.prototype = {
	         ...
	         * 动画
	         *
	         * @param {string} path 需要添加动画的属性获取路径，可以通过a.b.c来获取深层的属�?
	 ...
	 // TODO getTotalLength, getPointAtLength
	    ...
	    PathProxy.prototype = {
	        ...
	        moveTo: function (x, y) {
	            ...
	            // 有可能在 beginPath 之后直接调用 lineTo，这时�? x0, y0 需�?
	        ...
	        getBoundingRect: function () {
	            ...
	            for (var i = 0; i < data.length;) {
	                ...
	                switch (cmd) {
	                    case CMD.M:
	                        // moveTo 命令重新创建一个新�? subpath, 并且更新新的起点
	                        // �? closePath 的时候使�?
	                        x0 = data[i++];
	                        y0 = data[i++];
	                        xi = x0;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var yDim = [];
	    /**
	     * 从三阶贝塞尔曲线(p0, p1, p2, p3)中计算出最小包围盒，写入`min`和`max`�?
	     * @memberOf module:zrender/core/bbox
	     * @param {number} x0
	     * @param {number} y0
	     * @param {number} x1
	    ...
	    /**
	     * 从二阶贝塞尔曲线(p0, p1, p2)中计算出最小包围盒，写入`min`和`max`�?
	     * @memberOf module:zrender/core/bbox
	     * @param {number} x0
	     * @param {number} y0
	     * @param {number} x1
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param {boolean} isLoop
	     * @param {Array} constraint 将计算出来的控制点约束在一个包围盒�?
