 ...
 *
 * @author:xuxiaoyang
 * @Date: 2017/12/19  14:26
 * @Description: 系统服务demo
 */
public class SystemDemo {
    ...
    public static String getMemery() {
        ...
        System.out.println("物理内存:"+totalvirtualMemory);
        long freePhysicalMemorySize = osmxb.getFreePhysicalMemorySize();
        System.out.println("空闲的物理内存："+freePhysicalMemorySize);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("cpu占有率=" + SystemDemo.getCpuRatioForWindows());
        System.out.println("已使用内存=" + SystemDemo.getMemery());
        System.out.println("各盘占用情况：" + SystemDemo.getDisk());
